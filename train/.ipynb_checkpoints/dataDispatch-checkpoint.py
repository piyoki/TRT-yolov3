...
classes = ['sakura', 'other']
workFolder  = os.getcwd()
dataFolder  = workFolder+"/train/data"
trainList   = workFolder+"/train/train.txt"	 # Output the images list for training
testList    = workFolder+"/train/test.txt"	 # Output the images list for testing
fileCount   = 0
